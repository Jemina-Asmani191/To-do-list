    ...
    <div class="clearfix"></div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="card-text">
                        ...
                        <div class="float-end">
                            <a href="{{route('task.edit', $task->id)}}" title="Edit" class="btn btn-success"><i class="fa fa-edit"></i></a>
        ...
        @if (count($tasks) === 0)
            <div class="alert alert-danger p-2">
                ...
                <br><br>
                <a href="{{route('task.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus-circle"></i> Create task</a>
            </div>
        @endif
